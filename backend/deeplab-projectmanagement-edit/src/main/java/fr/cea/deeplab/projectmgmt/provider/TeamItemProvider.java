...
/**
 * This is the item provider adapter for a {@link fr.cea.deeplab.projectmgmt.Team} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class TeamItemProvider extends ResourceItemProvider {
    ...
    protected void addMembersPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_Team_members_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_Team_members_feature", "_UI_Team_type"),
                ProjectmgmtPackage.Literals.TEAM__MEMBERS, true, false, true, null, null, null));
    }
