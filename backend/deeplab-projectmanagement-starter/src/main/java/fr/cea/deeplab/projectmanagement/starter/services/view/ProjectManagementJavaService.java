 ...
 * @author lfasani
 */
public class ProjectManagementJavaService {

    private static final String NEW_TASK = "New Task";

    private final IFeedbackMessageService feedbackMessageService;

    public ProjectManagementJavaService(IFeedbackMessageService feedbackMessageService) {
    ...
    public void createWorkpackage(EObject context) {
        Workpackage newWorkpackage = ProjectmgmtFactory.eINSTANCE.createWorkpackage();
